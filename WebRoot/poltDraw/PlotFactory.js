...
define([
    "dojo/_base/declare",
    '/arcgis_js_plot/poltDraw/ext/sector.js',
    '/arcgis_js_plot/poltDraw/ext/double_arrow.js',
    '/arcgis_js_plot/poltDraw/ext/fine_arrow.js',
    '/arcgis_js_plot/poltDraw/ext/squad_combat.js',
    '/arcgis_js_plot/poltDraw/ext/attack_arrow.js',
    '/arcgis_js_plot/poltDraw/ext/tailed_squad_combat.js',
    '/arcgis_js_plot/poltDraw/ext/tailed_attack_arrow.js',
    '/arcgis_js_plot/poltDraw/ext/gathering_place.js',
    '/arcgis_js_plot/poltDraw/ext/closed_curve.js'
